...
def main(args):
    ...
    for lang_pair in language_pairs:
        tasks.append(MTTask(lang_pair[0],lang_pair[1],'flores', args.src_path, args.tgt_path, args.output_path))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--src_path", type=str, default="",
                        help="local path for source sentences")
    parser.add_argument("--tgt_path", type=str, default="",
                        help="local path for target sentences")
