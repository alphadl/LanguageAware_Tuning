...
def _load_local_data(path) -> List[str]:
    # load local dataset
...
class MTTask:
    ...
    def __init__(self,
        ...
        self.src_path = src_path # path for source sentences
        self.tgt_path = tgt_path # path for target sentences
        ...
        if output_path == '':
            ...
            self.out_dir = Path(output_path) # path for output
    ...
    def evaluate(self, translation_method: callable, type='direct', source_contrastive=1, source_weight=None, language_contrastive=None, language_weight=None) -> Path:
        ...
        if type == 'direct':
            ...
            for pair in tqdm(list(zip(*multi_source_sentences))):
                ...
                if "\n" in translation or "\r" in translation:
                    ...
                    print("one translation contains line break")
        ...
        #         # 'sentence']
        #     target_sentences = _load_local_data(self.tgt_path)
